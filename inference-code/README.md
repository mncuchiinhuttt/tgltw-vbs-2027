...
4. **Type 2 (Visual Question Answering)**: Decomposes queries into sub-queries, executes `Rex-Omni` object detection on candidates, crops bounding boxes, scores VQA crops using a VLM, and returns `<video_name>, <timestamp>, <answer>`.
