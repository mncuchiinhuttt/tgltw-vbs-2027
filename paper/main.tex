...
\begin{enumerate}\setlength{\itemsep}{1.5pt}\setlength{\parskip}{0pt}
    \item \textbf{High-Capacity Representation with Matryoshka Representation Learning (MRL)}: We deploy Tencent WeMM-Embedding-4B~\cite{wemm2025} with 2,048d vectors indexed via Qdrant HNSW~\cite{malkov2018efficient,qdrant} ($M=16, ef=128$). We choose this model for its unified image-text representation and fine-grained scene coverage; SigLIP adds complementary visual similarity.
